      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        >
          ...
          <h1 className="font-serif text-4xl md:text-7xl font-bold text-slate-900 leading-tight mb-6">
            ...
            <div className="text-academic-600 text-xl md:text-2xl font-serif font-normal mt-2">Ph.D., Psychology and Neuroscience</div>
          </h1>
          <div className="md:hidden flex flex-col items-center justify-center gap-4 mb-6">
            <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <a href="https://x.com/NadjaGingJehli" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                    <img src="https://img.freepik.com/premium-vector/twitter-new-logo-twitter-icons-twitter-x-logo_1036746-408.jpg?w=826" alt="X (Twitter)" width="14" height="14" className="rounded transition-transform hover:scale-110" style={{ background: 'white' }} />
                  </a>
                  <a href="https://www.linkedin.com/in/nadja-ging-jehli-phd-7b1539a9" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-slate-700 hover:text-academic-600 transition-colors" xmlns="http://www.w3.org/2000/svg"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.5 11.28h-3v-5.6c0-1.34-.03-3.07-1.87-3.07-1.87 0-2.16 1.46-2.16 2.97v5.7h-3v-10h2.88v1.36h.04c.4-.75 1.38-1.54 2.84-1.54 3.04 0 3.6 2 3.6 4.59v5.59z"/></svg>
                  </a>
                  <a href="https://scholar.google.com/citations?user=V8zeDrIAAAAJ" target="_blank" rel="noopener noreferrer" aria-label="Google Scholar">
                    <img src="https://listimg.pinclipart.com/picdir/s/485-4850859_free-png-google-icon-google-plus-logo-blanco.png" alt="Google Scholar" width="14" height="14" className="rounded transition-transform hover:scale-110" style={{ background: 'white' }} />
                  </a>
                  <a href="https://orcid.org/0000-0002-1071-0693" target="_blank" rel="noopener noreferrer" aria-label="ORCID">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/ORCID_iD.svg/960px-ORCID_iD.svg.png?20190308043226" alt="ORCID" width="14" height="14" className="rounded transition-transform hover:scale-110" style={{ background: 'white' }} />
                  </a>
                  <a href="https://bsky.app/profile/nadjagingjehli.bsky.social" target="_blank" rel="noopener noreferrer" aria-label="Bluesky">
                    <img src="/assets/Bluesky_Logo.jpg" alt="Bluesky" width="14" height="14" className="rounded transition-transform hover:scale-110" />
                  </a>
                  <a href="https://www.researchgate.net/profile/Nadja-Ging-Jehli" target="_blank" rel="noopener noreferrer" aria-label="ResearchGate">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/ResearchGate_icon_SVG.svg" alt="ResearchGate" width="14" height="14" className="rounded transition-transform hover:scale-110" style={{ background: 'white' }} />
                  </a>
                </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-wrap gap-2 justify-center md:justify-start mb-8">
            <span className="text-xs py-1 px-3 bg-slate-100 text-slate-600 rounded-full font-medium">Agency</span>
            <span className="text-xs py-1 px-3 bg-slate-100 text-slate-600 rounded-full font-medium">Controllability</span>
            <span className="text-xs py-1 px-3 bg-slate-100 text-slate-600 rounded-full font-medium">Persistence vs. Escape</span>
            <span className="text-xs py-1 px-3 bg-slate-100 text-slate-600 rounded-full font-medium">Adaptive Intelligence</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-12">
            <a
              href="/assets/CV_GingJehli_o_060926.pdf"
              target="_blank"
            ...
            <Link 
              to="/contact" 
              className="px-6 sm:px-12 w-full sm:w-72 py-3 bg-academic-800 text-white rounded-lg font-medium hover:bg-academic-900 transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            >
              <Mail size={18} />
              Get in Touch
            </Link>
