        ...
        <div className="container mx-auto px-6 max-w-4xl">
            ...
            >
                ...
                <p className="text-lg md:text-xl text-slate-600 font-light">
                    Full list of peer-reviewed journal articles. For preprints, conference proceedings, and book chapters, please see <a href="/assets/CV_GingJehli_o_060926.pdf" target="_blank" rel="noopener noreferrer" className="text-academic-700 hover:text-academic-800 underline">CV</a>.
                </p>
            </motion.div>
